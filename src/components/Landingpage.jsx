  ...
  <span className='text-slate-900 font-semibold text-5xl ml-1'>
    in <br/> a few minutes
        ...
        <p className='m-0 max-w-[400px] w-full text-slate-800 font-normal text-sm py-6'>
            ...
            <br/>and find reliable delivery partners, all in one place built for Africa's reality.
        </p>
    ...
    <div className='flex flex-col w-full h-full relative'>
        ...
        <div className='w-[150px] flex bg-white gap-2 items-center shadow-xl rounded-xl'>
            <img src='./bars.svg' alt='icon' width={40} height={40}/>
            <p className='m-0 text-[10px]'>converts 17% better on sales</p>
        </div>
    </div>
        <div className='flex justify-between w-full absolute bottom-0'>
            <div className='w-[150px] flex bg-white gap-2 p-2 items-center shadow-xl rounded-xl ml-[-25px]'>
                <img src='./ai.svg' alt='icon' width={40} height={40}/>
                <p className='m-0 text-[10px]'>Get more done with AI</p>
            </div>
            <div className='w-[150px] flex bg-white gap-2 p-2 items-center shadow-xl rounded-xl mr-3'>
                <img src='./checkmark.svg' alt='icon' width={40} height={40}/>
                <p className='m-0 text-[10px]'>Free, fast, flexible and reliable</p>
            </div>
        </div>
    </div> 
 </div>
...
<div className='flex flex-col w-full h-full items-center justify-center'>
  ...
  Build your store <span className='text-slate-900 font-semibold text-3xl ml-1'>in a few minutes</span>
    </p>
        ...
        <div className='flex items-center gap-4 mt-auto'>
            <button className='flex items-center justify-center rounded-full border p-3 bg-blue-700 text-white text-sm font-normal'>
                Join the waitlist
            </button>
    ...
    <div className='flex flex-col w-full h-full relative'>
        ...
        />
         <div className='absolute top-18 right-8'>
            <div className='w-[80px] flex bg-white gap-1 px-0 items-center shadow-xl rounded-lg -rotate-12'>
                <img src='./checkmark.svg' alt='icon' width={30} height={30}/>
                <p className='m-0 text-[6px]'>Free, fast, flexible and reliable</p>
            </div>
        <div className='w-[80px] flex bg-white gap-1 px-0 items-center shadow-xl rounded-lg -rotate-3 mt-1'>
            <img src='./bars.svg' alt='icon' width={30} height={30}/>
            <p className='m-0 text-[6px]'>converts 17% better on sales</p>
        </div>
    </div>
        <div className='flex justify-between w-full absolute bottom-30 left-[-10px] px-6'>
            <div className='w-[80px] flex bg-white gap-1 px-0 items-center shadow-xl rounded-lg'>
                <img src='./ai.svg' alt='icon' width={30} height={30}/>
                <p className='m-0 text-[6px]'>Get more done with AI</p>
            </div>
        ...
        <div className='flex flex-col w-full gap-2 items-center justify-center md:items-start md:justify-start'>
            <p className='m-0 text-slate-800 font-medium text-sm'>Trusted by top companies</p>
            <div className='flex w-full justify-between items-center'>
                <img 
                src='./partner-logo5.svg' 
                alt='logo' width={40} height={40} className="filter-black"/>
                <img 
        ...
        <div className='md:flex w-full md:justify-between justify-center h-full gap-8 items-stretch'>
            <div className='flex flex-col md:gap-3 gap-1 mb-8'>
                <img src='build.svg' alt='img'className="w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover" />
                <h2 className='md:text-3xl text-lg text-slate-700 font-semibold'>Build your store in minutes with AI tools</h2>
                <p className='m-0 md:text-xl text-sm text-slate-700 font-normal'>Create a stunning online store without a single line of code.</p>
            </div>
            <div className='flex flex-col md:gap-3 gap-1 mb-8'>
                <img src='payment.svg' alt='img' className="w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover" />
                <h2 className='md:text-3xl text-lg text-slate-700 font-semibold'>Collect payments confidently</h2>
                <p className='m-0 md:text-xl text-sm text-slate-700 font-normal'>With integrated payment gateways and escrow protection that builds trust.</p>
            </div>
            <div className='flex flex-col md:gap-3 gap-1'>
                <img src='partners.svg' alt='img' className="w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover" />
                <h2 className='md:text-3xl text-lg text-slate-700 font-semibold'>Find trusted delivery partners</h2>
                <p className='m-0 md:text-xl text-sm text-slate-700 font-normal'>Connect instantly with reliable agents — no more endless calls or lost orders.</p>
            </div>
        </div>
        {/* fourth */}
      ...
      <div className="flex items-center justify-center bg-[#D99426]/11 py-8">
        <div className='flex flex-col items-start md:items-center justify-center w-full max-w-6xl md:gap-3 gap-1 px-4 md:px-8'>
          <h3 className='md:text-xl text-lg font-semibold text-slate-700'>
            Kaihma makes selling online fun, easy, and trustworthy.
          </h3>
          <p className='m-0 md:text-center text-sm font-normal text-slate-700'>
            Kaihma is an all-in-one platform that helps African entrepreneurs 
            build trusted online stores, collect payments, and find reliable 
            delivery partners. Kaihma empowers anyone selling online, from fashion 
            and skincare brands to gadget stores and logistics companies. 
            to build your own online store, your brand, your customers, your control.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className='hidden md:flex w-full h-full items-stretch'>
            ...
            <div className='w-full flex flex-col bg-blue-700 rounded-r-md py-8 px-6 gap-3'>
                <p className='m-0 text-white font-semibold text-3xl'>Be first to experience the future of selling online</p>
                <p className='m-0 text-white font-normal text-sm'>Join 1, 000+ entrepreneurs waiting to sell boldly with Kaihma. 
                    Get early access, product updates, and exclusive founder insights.</p>
...
{/* fifth */}
  ...
  <div className="relative z-10 flex flex-col justify-end bg-black/50 p-4 gap-3">
    ...
    <p className="text-white text-xs leading-relaxed">
      Join 1,000+ entrepreneurs waiting to sell boldly with Kaihma. 
      Get early access, product updates, and exclusive founder insights.
    </p>
    <div className="flex w-full justify-start pt-2">
      <button className="rounded-full bg-[#E09213] py-3 px-6 text-white text-sm font-medium hover:bg-[#c87f10] transition-colors duration-200">
        Join the waitlist
      </button>
    </div>
  </div>
      ...
      {faqs.map((faq, index) => (
        ...
        <div className='w-full flex flex-col text-center gap-4'>
            <p className='m-0 text-slate-700 font-semibold text-2xl'>Get the best services with our app</p>
            <p className='m-0 text-slate-700 font-normal text-sm'>Be among the first to get our app when it launches and 
                enjoy exciting free tools to scale-up your business.  
                Everything you need to grow your business with high 
                conversion rate, all in one place. </p>
        </div>
