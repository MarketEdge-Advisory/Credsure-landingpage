    ...
    <footer className="bg-[#0A2647] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row gap-12 lg:gap-16 mb-8">
          {/* Brand Section */}
          <div className="space-y-4 md:flex-1 max-w-xs">
            <div className="flex items-center gap-4">
            <img src='/suzuki-footer-logo.svg' alt="Suzuki Logo" className="text-3xl font-bold" />
              
                <img src='/credsure-footer-logo.svg' alt="Credsure Logo" className="flex leading-tight" />
          ...
          <div className="flex-shrink-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Consumer Rights</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Responsible Lending</a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex-shrink-0">
            <h3 className="text-lg font-semibold mb-4">Credsure Customer Support</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Clock size={18} className="mt-1 flex-shrink-0" />
                <span className="text-sm text-gray-300">Monday - Friday, 9:00 AM - 6:00 PM WAT</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="flex-shrink-0" />
                <a href="tel:+2341234567890" className="text-sm text-gray-300 hover:text-white transition-colors">+234 123 456 7890</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="flex-shrink-0" />
                <a href="mailto:support@credsure.com" className="text-sm text-gray-300 hover:text-white transition-colors">support@credsure.com</a>
              </li>
            </ul>
          </div>
          ...
          {/* CFAO (Suzuki) */}
          <div className="flex-shrink-0">
            <h3 className="text-lg font-semibold mb-4">CFAO (Suzuki)</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="https://www.cfaogroup.com/en/homepage/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-300 hover:text-white transition-colors break-all">https://www.cfaogroup.com/en/homepage/</a>
              </li>
            </ul>
          </div>
        </div>
