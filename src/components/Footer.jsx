    ...
    return (
        <footer className="bg-[#0A2647] text-white">
                ...
                <div className="flex flex-col md:flex-row md:justify-between gap-8 sm:gap-12 lg:gap-16 mb-6 sm:mb-8">
                    ...
                    <div className="space-y-3 sm:space-y-4 md:flex-1 max-w-xs">
                        ...
                        <p className="text-xs sm:text-sm text-gray-300">
                           CredSure Loans by Afridev & Suzuki by CFAO, partnering
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              <li>
                <a href="https://www.credsureloans.com/privacy-policy" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors">Privacy Policy</a>
              </li>
              {/* <li>
                <a href="#" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors">Terms of Service</a>
              </li> */}
              <li>
                <a href="https://www.credsureloans.com/cookies-policy" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors">Cookie Policy</a>
              </li>
              {/* <li>
              ...
              <li>
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <ul className="space-y-2 sm:space-y-3">
                            <li className="flex items-start gap-2 sm:gap-3">
                                <Clock
                                    size={16}
                                    className="mt-0.5 sm:mt-1 flex-shrink-0 sm:w-[18px] sm:h-[18px]"
                                />
                ...
                <a href="tel:+2348129940740" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors">+234 812 994 0740</a>
              </li>
                            <li className="flex items-center gap-2 sm:gap-3">
                                <Mail
                                    size={16}
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <ul className="space-y-2 sm:space-y-3">
                            <li className="flex items-start gap-2 sm:gap-3">
                                ...
                                />
                                <span className="text-xs sm:text-sm text-gray-300">
                                    13A Akin Adesola, Victoria Island Lagos.
                                </span>
                            </li>
                            <li className="flex items-center gap-2 sm:gap-3">
                <Phone size={16} className="flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
                <a href="tel:+234906 121 1111" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors">+234906 121 1111</a>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                                <Mail
                                    size={16}
                            ...
                            {/* <li className="flex items-start gap-2 sm:gap-3">
                                ...
                                <a
                                    ...
                                    className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors break-all"
                                >
                                    https://www.cfaogroup.com/en/homepage/
                                </a>
                            </li> */}
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-700 pt-4 sm:pt-6 mb-4">
                    <p className="text-[10px] sm:text-xs text-gray-400">
                        <strong>Important Disclaimer:</strong> Monthly payment
                        estimates are indicative and subject to final credit
